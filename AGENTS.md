...
- **Inconsistency & scale register:** `AUDIT_INCONSISTENCY_REGISTER.md` (V27.4.0). Wallet: `shared/wallet.py`. Lead identity: `shared/lead_identity.py`. Queue dual-path: `shared/campaign_queue.py` (`CAMPAIGN_QUEUE_MODE=hybrid|subcollection|array`). Serper residual budget: `shared/serper_budget.py`.
