"""
Sideio Lead Sniper -- Pipeline Main Service Entrypoint (V23 Phase 3 Final Cutover).

All routes migrated to Blueprint architecture. Legacy monolith removed.

Blueprint Registry:
  /produce   -> api/routers/produce.py
  /dispatch  -> api/routers/dispatch.py
  /finalize  -> api/routers/dispatch.py
"""
...
def create_app() -> Flask:
    ...
    log.info("pipeline_started", version="23.1.0", phase="final-cutover")
    return app
